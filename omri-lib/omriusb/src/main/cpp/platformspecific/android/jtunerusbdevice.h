...
public:
    ...
    virtual void ewsAlert(const Fig_00_Ext_15& alert, uint16_t tunedEnsembleId);
...
private:
    ...
    jmethodID m_usbTunerEwsAlertMId;
    ...
    // Broadcast DAB->FM link (FIG 0/6+0/21), set on the scanned service when the ensemble carries it.
    jmethodID m_dabServiceSetLinkedFmFrequencyMId;
    jmethodID m_dabServiceSetLinkedFmPiMId;
