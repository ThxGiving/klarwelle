...
private:
    ...
    // FIG 0/15 (DAB EWS / ASA) subscription: forwards each decoded alert to the Java tuner.
    std::shared_ptr<std::function<void(const Fig_00_Ext_15&)>> m_ewsAlertCb;
    void onEwsAlert(const Fig_00_Ext_15& alert);
