...
public:
    ...
    using Fig_00_15_Callback = std::function<void(const Fig_00_Ext_15&)>;
...
public:
    ...
    std::shared_ptr<Fig_00_15_Callback> registerFig_00_15_Callback(Fig_00_15_Callback cb);
...
private:
    ...
    CallbackDispatcher<Fig_00_15_Callback> m_fig00_15dispatcher;
