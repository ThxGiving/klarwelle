...
public interface TunerListener extends RadioListener {
	...
	/**
	 * A DAB Emergency Warning System (EWS, ETSI TS 104 089 / "ASA") FIG 0/15 was received on the
	 * tuned ensemble. Fired for every instance including the heartbeat form. Default no-op so existing
	 * listeners need not implement it.
	 * @param tuner the {@link Tuner} that received the alert
	 * @param alert the decoded {@link DabEwsAlert}
	 */
	default void tunerDabEwsAlert(Tuner tuner, DabEwsAlert alert) {}
}
